...
function SidebarProvider({
  ...
  // Sidebars stay docked at every window width in the desktop app; no responsive
  // switch to a closed off-canvas overlay. openMobile is kept only to satisfy the
  // context shape below.
