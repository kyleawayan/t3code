 ...
 * (approval), "in motion" (working), "gone quiet" (stalled), and "broken"
 * (failed). Ready is the unlabeled resting state.
 */
export type ThreadListV2Status = "approval" | "input" | "stalled" | "working" | "failed" | "ready";
...
export function resolveThreadListV2Status(
  thread: Pick<
    EnvironmentThreadShell,
    "hasPendingApprovals" | "hasPendingUserInput" | "session" | "stalled"
  >,
): ThreadListV2Status {
